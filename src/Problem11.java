...
public class Problem11 {
	...
	public static void main(String[] args) {
		...
		// I have kind of cheated here. I used all the methods one at a time to
		// figure out which one truly works
		// After checking that leftdiagonalprod yields the highest product, I
		// chose it.
	...
	// Create the methods to get the products and also the max of the final list
	// of products
