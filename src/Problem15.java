...
public class Problem15 {
	...
	public static void main(String[] args) {
		...
		System.out.println(factorial(new BigInteger(Long.toString(2*20))).divide(factorial(new BigInteger(Long.toString(20))).multiply(factorial(new BigInteger(Long.toString(20))))));
