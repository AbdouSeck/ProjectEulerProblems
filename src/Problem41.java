...
public class Problem41 {
	...
	public static void main(String[] args) {
		...
		// Tested for 9 and 8 digit numbers and it didn't work and I moved to 7
		// digit numbers
	...
	// Use the merge function to determine all the permutations of a set of
	// characters
	...
	// Create a merge function that adds extra characters to an already
	// designated string
